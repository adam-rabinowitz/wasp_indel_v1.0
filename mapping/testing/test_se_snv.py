...
class TestSNV(TestGenerateVariantReads):
    ...
    def test01_multiple_snv(self):
        ...
        self.input.add_variant(
            name='V01', pos=3, ref='A', alt='T'
        )
        self.input.add_variant(
            name='V02', pos=8, ref='T', alt='G'
        )
        ...
        self.assertEqual(log['read variant types']['biallelic snv'], 2)
    ...
    def test02_multiple_snv(self):
        ...
        self.assertEqual(log['read variant types']['snv'], 1)
    ...
    def test03_snv_over_indels(self):
        # Add variants
        self.input.add_variant(
